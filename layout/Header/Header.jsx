...
import skip from '../../public/assets/images/boats/skip-sport-19/skip-sport-1-removebg-preview.png';
...
const Header = ({ sticky }) => {
  ...
  const renderDesktopHeaderNavigation=()=><nav className="header__navigation">
...
const renderMobileHeaderNavigation=()=>   <nav className="header__mobile-navigation">
<TranslatedLink
...
<div className="header__hamburger-menu">
  ...
  <ul className="header__mobile-navigation--list">
    ...
    <li>
      ...
      <ul className={isMobileHeaderBoatsSubmenuOpened? 'submenu submenu--opened boats-submenu': "submenu"}>
        <li>
          <TranslatedLink
            onClick={closeMobileMenu}
            href="/plovila/sportstar-22"
    ...
    <li>
      ...
      <ul className={isMobileHeaderMainServicesSubmenuOpened? 'submenu submenu--opened services-submenu': "submenu"}>
        <li>
          <TranslatedLink
            onClick={closeMobileMenu}
            href="/usluge/mehanicarske-usluge"
    ...
    <li>
      ...
      <ul className={isMobileHeaderEnginesSubmenuOpened? 'submenu submenu--opened engines-submenu':'submenu'}>
        <li>
          <TranslatedLink
            onClick={closeMobileMenu}
            href="/vanbrodski-motori/novi-motori"
    ...
    <li>
      ...
      <ul className={isMobileHeaderEquipmentSubmenuOpened?'submenu submenu--opened additional-equipment-submenu':"submenu"}>
        <li>
          <TranslatedLink
            onClick={closeMobileMenu}
            href="/dodatna-oprema/propeleri"
